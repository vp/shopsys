...
class ProductImageUploadCest
{
    ...
    public function testSuccessfulImageUpload(AcceptanceTester $me, EntityEditPage $entityEditPage, LoginPage $loginPage)
    {
        ...
        $me->seeTranslationAdmin('Product <strong><a href=\"%url%\">%productName%</a></strong> modified', 'messages', [
            '%url%' => '',
            '%productName%' => t('22" Sencor SLE 22F46DM4 HELLO KITTY', [], 'dataFixtures', $me->getAdminLocale()),
        ]);
    }
}
